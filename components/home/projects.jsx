            ...
            {ProjectsData.map((data, index) => {
                return (
                    <motion.div
                        ...
                        <button className="flex mt-16 border-2 px-6 py-4 text-gray-100 hover:text-gray-900 bg-transparent hover:bg-white tracking-widest transition duration-150 ease-in-out">
