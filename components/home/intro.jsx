        ...
        <div className="container mx-auto px-10">
            <div className="flex justify-center items-center h-screen">
                <div className="max-w-5xl lg:max-w-4xl tracking-wider">
                    ...
                    <p className="text-xl lg:text-2xl text-gray-500 light leading-loose mt-6 md:mt-8 lg:mt-10">
                        Born and raised in the beautiful Portuguese coast.
                    </p>
                    <p className="text-xl lg:text-2xl text-gray-500 light leading-loose lg:leading-10 mt-0 md:mt-1 lg:mt-2">
